...
max_right_pos = False
max_left_pos = True
minPos = 5 # This is the most left position within non-breakage range for the servo
maxPos = 10 # This is the most right position within non-breakage range for the servo
